...
DevelopmentDTO _$DevelopmentDTOFromJson(
  ...
  ..developmentCoverPhotoImage = json['developmentCoverPhotoImage'] as String
...
Map<String, dynamic> _$DevelopmentDTOToJson(DevelopmentDTO instance) =>
    <String, dynamic>{
      ...
      'developmentCoverPhotoImage': instance.developmentCoverPhotoImage,
